...
/**
 * This class represents a Holder for a Mail Folder in Thunderbird 
 * @author Olivier PARNIERE BT France
 *
 */
public class FolderHolder {
	private CFolderHolder holder;
	
	public FolderHolder() {
		holder = new CFolderHolder();
	}

	public FolderHolder(CFolderHolder holder) {
		this.holder = holder;
	}
	
	public Folder getValue(){
		return new Folder(holder.value);
	}

	public CFolderHolder getCorbaObject() {
		return holder;
	}
