 ...
 *
 * ***** END LICENSE BLOCK ***** */
#ifndef SOURCESTREAMLISTENER_H_
#define SOURCESTREAMLISTENER_H_

#include "nsIStreamListener.h"
#include "nsIInputStream.h"
#include "Services.h"

class SourceStreamListener : public nsIStreamListener
{
public :
	NS_DECL_ISUPPORTS

	SourceStreamListener(SourceListener_ptr p_SourceListener):
		m_SourceListener(p_SourceListener){
		m_done = PR_FALSE;
	};

    virtual ~SourceStreamListener(){}
...
private :
	...
	SourceListener_ptr m_SourceListener;
	PRBool m_done;

};

#endif /*SOURCESTREAMLISTENER_H_*/
