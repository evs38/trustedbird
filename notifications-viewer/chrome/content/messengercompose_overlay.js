...
var nViewerObserverService = Components.classes["@mozilla.org/observer-service;1"].getService(Components.interfaces.nsIObserverService);
nViewerObserverService.addObserver(nViewerSendObserver, "mail:composeOnSend", false);
