...
{
public:
  void SendMessage(const Account& p_account, const CMessage& p_message, MessageSendListener_ptr p_listener);
...
public:
  ...
  virtual void SendMessage(const Account& p_account, const CMessage& p_message, MessageSendListener_ptr p_listener) = 0;
