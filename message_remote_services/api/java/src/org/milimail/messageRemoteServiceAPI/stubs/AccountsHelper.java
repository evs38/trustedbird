...
{
  private static String  _id = "IDL:Accounts:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      __typeCode = AccountHelper.type ();
      __typeCode = org.omg.CORBA.ORB.init ().create_sequence_tc (0, __typeCode);
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (AccountsHelper.id (), "Accounts", __typeCode);
    }
    return __typeCode;
  }
  ...
  public static Account[] read (org.omg.CORBA.portable.InputStream istream)
  {
    ...
    value = new Account[_len0];
    for (int _o1 = 0;_o1 < value.length; ++_o1)
      value[_o1] = AccountHelper.read (istream);
    return value;
  }
  ...
  public static void write (org.omg.CORBA.portable.OutputStream ostream, Account[] value)
  {
    ...
    for (int _i0 = 0;_i0 < value.length; ++_i0)
      AccountHelper.write (ostream, value[_i0]);
  }
