...
/**
* CAttachmentHelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from ../message_remote_services/src/corba/Services.idl
* Thursday, September 4, 2008 2:33:40 PM CEST
*/

abstract public class CAttachmentHelper
{
  private static String  _id = "IDL:CAttachment/CAttachment:1.0";
      ...
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _members0[2] = new org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          __typeCode = org.omg.CORBA.ORB.init ().create_struct_tc (CAttachmentHelper.id (), "CAttachment", _members0);
          __active = false;
        }
      }
    }
  ...
  {
    CAttachment value = new CAttachment ();
