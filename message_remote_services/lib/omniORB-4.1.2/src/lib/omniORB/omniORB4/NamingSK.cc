...
void CosNaming::_objref_NamingContext::list(::CORBA::ULong how_many, BindingList_out bl, BindingIterator_out bi)
{
...
CosNaming::_objref_NamingContextExt::_objref_NamingContextExt(omniIOR* ior, omniIdentity* id) :
   ...
   OMNIORB_BASE_CTOR(CosNaming::)_objref_NamingContext(ior, id)
