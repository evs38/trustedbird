...
CosNotifyFilter::ConstraintInfoSeq* CosNotifyFilter::_objref_Filter::add_constraints(const ConstraintExpSeq& constraint_list)
{
  _0RL_cd_1fe8f330207afd15_00000000 _call_desc(_0RL_lcfn_1fe8f330207afd15_10000000, "add_constraints", 16);
  _call_desc.arg_0 = &(ConstraintExpSeq&) constraint_list;
...
void CosNotifyFilter::_objref_Filter::modify_constraints(const ConstraintIDSeq& del_list, const ConstraintInfoSeq& modify_list)
{
  _0RL_cd_1fe8f330207afd15_20000000 _call_desc(_0RL_lcfn_1fe8f330207afd15_30000000, "modify_constraints", 19);
  _call_desc.arg_0 = &(ConstraintIDSeq&) del_list;
  _call_desc.arg_1 = &(ConstraintInfoSeq&) modify_list;
...
CosNotifyFilter::ConstraintInfoSeq* CosNotifyFilter::_objref_Filter::get_constraints(const ConstraintIDSeq& id_list)
{
  _0RL_cd_1fe8f330207afd15_40000000 _call_desc(_0RL_lcfn_1fe8f330207afd15_50000000, "get_constraints", 16);
  _call_desc.arg_0 = &(ConstraintIDSeq&) id_list;
...
void CosNotifyFilter::_objref_Filter::detach_callback(CallbackID callback)
{
...
CosNotifyFilter::MappingConstraintInfoSeq* CosNotifyFilter::_objref_MappingFilter::add_mapping_constraints(const MappingConstraintPairSeq& pair_list)
{
  _0RL_cd_1fe8f330207afd15_91000000 _call_desc(_0RL_lcfn_1fe8f330207afd15_a1000000, "add_mapping_constraints", 24);
  _call_desc.arg_0 = &(MappingConstraintPairSeq&) pair_list;
...
void CosNotifyFilter::_objref_MappingFilter::modify_mapping_constraints(const ConstraintIDSeq& del_list, const MappingConstraintInfoSeq& modify_list)
{
  _0RL_cd_1fe8f330207afd15_b1000000 _call_desc(_0RL_lcfn_1fe8f330207afd15_c1000000, "modify_mapping_constraints", 27);
  _call_desc.arg_0 = &(ConstraintIDSeq&) del_list;
  _call_desc.arg_1 = &(MappingConstraintInfoSeq&) modify_list;
...
CosNotifyFilter::MappingConstraintInfoSeq* CosNotifyFilter::_objref_MappingFilter::get_mapping_constraints(const ConstraintIDSeq& id_list)
{
...
CosNotifyFilter::FilterID CosNotifyFilter::_objref_FilterAdmin::add_filter(Filter_ptr new_filter)
{
...
void CosNotifyFilter::_objref_FilterAdmin::remove_filter(FilterID filter)
{
...
CosNotifyFilter::Filter_ptr CosNotifyFilter::_objref_FilterAdmin::get_filter(FilterID filter)
{
