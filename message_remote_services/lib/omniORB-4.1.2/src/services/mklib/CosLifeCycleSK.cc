...
CosLifeCycle::Factories* CosLifeCycle::_objref_FactoryFinder::find_factories(const Key& factory_key)
{
  _0RL_cd_25b2b9dd5b4ad98d_00000000 _call_desc(_0RL_lcfn_25b2b9dd5b4ad98d_10000000, "find_factories", 15);
  _call_desc.arg_0 = &(Key&) factory_key;
...
CosLifeCycle::LifeCycleObject_ptr CosLifeCycle::_objref_LifeCycleObject::copy(FactoryFinder_ptr there, const Criteria& the_criteria)
{
  _0RL_cd_25b2b9dd5b4ad98d_20000000 _call_desc(_0RL_lcfn_25b2b9dd5b4ad98d_30000000, "copy", 5);
  _call_desc.arg_0 = there;
  _call_desc.arg_1 = &(Criteria&) the_criteria;
...
void CosLifeCycle::_objref_LifeCycleObject::move(FactoryFinder_ptr there, const Criteria& the_criteria)
{
...
::CORBA::Boolean CosLifeCycle::_objref_GenericFactory::supports(const Key& k)
{
  _0RL_cd_25b2b9dd5b4ad98d_80000000 _call_desc(_0RL_lcfn_25b2b9dd5b4ad98d_90000000, "supports", 9);
  _call_desc.arg_0 = &(Key&) k;
...
CORBA::Object_ptr CosLifeCycle::_objref_GenericFactory::create_object(const Key& k, const Criteria& the_criteria)
{
