...
CosTime::TimeComparison CosTime::_objref_UTO::compare_time(ComparisonType comparison_type, UTO_ptr uto)
{
...
CosTime::TIO_ptr CosTime::_objref_UTO::time_to_interval(UTO_ptr uto)
{
...
CosTime::OverlapType CosTime::_objref_TIO::spans(UTO_ptr time, TIO_out overlap)
{
...
CosTime::OverlapType CosTime::_objref_TIO::overlaps(TIO_ptr interval, TIO_out overlap)
{
