...
void CosNotification::_objref_QoSAdmin::set_qos(const QoSProperties& qos)
{
  _0RL_cd_8b6214f5b3100e7e_20000000 _call_desc(_0RL_lcfn_8b6214f5b3100e7e_30000000, "set_qos", 8);
  _call_desc.arg_0 = &(QoSProperties&) qos;
...
void CosNotification::_objref_QoSAdmin::validate_qos(const QoSProperties& required_qos, NamedPropertyRangeSeq_out available_qos)
{
  _0RL_cd_8b6214f5b3100e7e_40000000 _call_desc(_0RL_lcfn_8b6214f5b3100e7e_50000000, "validate_qos", 13);
  _call_desc.arg_0 = &(QoSProperties&) required_qos;
...
void CosNotification::_objref_AdminPropertiesAdmin::set_admin(const AdminProperties& admin)
{
  _0RL_cd_8b6214f5b3100e7e_70000000 _call_desc(_0RL_lcfn_8b6214f5b3100e7e_80000000, "set_admin", 10);
  _call_desc.arg_0 = &(AdminProperties&) admin;
