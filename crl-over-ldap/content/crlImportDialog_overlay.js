...
// Extension Hook : replace the built in onLoad function with our own...
var crl_over_ldap_OriginalOnLoad = onLoad;
onLoad = function crl_over_ldap_onLoad() {

  // Call built in onLoad function
  crl_over_ldap_OriginalOnLoad();
