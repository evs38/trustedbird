...
var X_P772_Codress_message_indicator =
{
 getCellText: function(row, col)
  {
    var key = gDBView.getKeyAt(row);
    ...
    return hdr.getStringProperty("x-p772-codress-message-indicator");
  },

 getSortStringForRow:	function(hdr)		       { return hdr.getStringProperty("x-p772-codress-message-indicator"); },
  isString:             function()   { return true; },
  getCellProperties:	function(row, col, props)	{ },
  getRowProperties : 	function(row,props){},
  getImageSrc:          function(row, col) {return null;},
...
function addCustomColumnHandler() 
{
	...
	gDBView.addColumnHandler("X-P772-Codress-message-indicator", X_P772_Codress_message_indicator);
