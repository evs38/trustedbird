...
public class _MessageBrowseServiceStub extends org.omg.CORBA.portable.ObjectImpl implements MessageBrowseService
{
  ...
  public void GetSourceMessage (CMessageHdr p_messageHdr, SourceListener p_sourceListener) throws CInternalServerException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                GetSourceMessage (p_messageHdr, p_sourceListener        );
            } finally {
                _releaseReply ($in);
            }
  } // GetSourceMessage

  public void GetHeaders (CMessageHdr p_messageHdr, HeadersListener p_headersListener) throws CInternalServerException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("GetHeaders", true);
                CMessageHdrHelper.write ($out, p_messageHdr);
                HeadersListenerHelper.write ($out, p_headersListener);
                $in = _invoke ($out);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                ...
                GetHeaders (p_messageHdr, p_headersListener        );
            } finally {
                _releaseReply ($in);
            }
  } // GetHeaders

  public void GetBody (CMessageHdr p_messageHdr, BodyListener p_bodyListener) throws CInternalServerException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("GetBody", true);
                CMessageHdrHelper.write ($out, p_messageHdr);
                BodyListenerHelper.write ($out, p_bodyListener);
                $in = _invoke ($out);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                ...
                GetBody (p_messageHdr, p_bodyListener        );
            } finally {
                _releaseReply ($in);
            }
  } // GetBody
