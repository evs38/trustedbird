...
/**
* CMessageHdrsHelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from ../message-remote-services/src/corba/Services.idl
* Friday, December 5, 2008 3:26:54 PM CET
*/

abstract public class CMessageHdrsHelper
{
  private static String  _id = "IDL:CMessageHdrs:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      __typeCode = CMessageHdrHelper.type ();
      __typeCode = org.omg.CORBA.ORB.init ().create_sequence_tc (0, __typeCode);
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (CMessageHdrsHelper.id (), "CMessageHdrs", __typeCode);
    }
    return __typeCode;
  }
  ...
  {
    CMessageHdr value[] = null;
    int _len0 = istream.read_long ();
    value = new CMessageHdr[_len0];
    for (int _o1 = 0;_o1 < value.length; ++_o1)
      value[_o1] = CMessageHdrHelper.read (istream);
    return value;
  }
  ...
  public static void write (org.omg.CORBA.portable.OutputStream ostream, CMessageHdr[] value)
  {
    ...
    for (int _i0 = 0;_i0 < value.length; ++_i0)
      CMessageHdrHelper.write (ostream, value[_i0]);
  }
