...
trustedBird_ldapQuery.prototype.launch = function(aLdapUri, aLdapEndCallback, aLdapEndCallbackParameter, aLdapMessageCallback, aLdapMessageCallbackParameter) {
    ...
    try {
        ...
        if (trustedBird_getPlatformVersion() >= "1.9") {
            this.ldapConnection.init(this.ldapURL, null, trustedBird_getProxyOnUIThread(this, Components.interfaces.nsILDAPMessageListener), null, Components.interfaces.nsILDAPConnection.VERSION3);
        } else {
            this.ldapConnection.init(this.ldapURL.asciiHost, this.ldapURL.port, this.ldapURL.options & this.ldapURL.OPT_SECURE, null, trustedBird_getProxyOnUIThread(this, Components.interfaces.nsILDAPMessageListener), null, Components.interfaces.nsILDAPConnection.VERSION3);
        }
    } catch (e) {
...
trustedBird_ldapQuery.prototype.bind = function() {
    ...
    try {
        ...
        this.ldapOperation.init(this.ldapConnection, trustedBird_getProxyOnUIThread(this, Components.interfaces.nsILDAPMessageListener), null);
...
trustedBird_ldapQuery.prototype.search = function() {
    ...
    try {
        ...
        this.ldapOperation.searchExt(this.ldapURL.dn, this.ldapURL.scope, this.ldapURL.filter, 0, this.ldapURL.getAttributes(new Object), 0, 0);
...
trustedBird_ldapQuery.prototype.onLDAPInit = function(aConnection, aStatus) {
    ...
    if (this.ldapEndCallback)
        this.ldapEndCallback(trustedBird_ldapQuery.CONNECT_ERROR, this.ldapEndCallbackParameter);
}
...
trustedBird_ldapQuery.prototype.onLDAPMessage = function(aMessage) {
    switch (aMessage.type) {
        case Components.interfaces.nsILDAPMessage.RES_BIND:
            ...
            if (this.ldapEndCallback)
                this.ldapEndCallback(trustedBird_ldapQuery.SEARCH_ERROR, this.ldapEndCallbackParameter);
            return;
            break;
    ...
    if (this.ldapEndCallback)
        this.ldapEndCallback(this.error, this.ldapEndCallbackParameter);
}
...
function trustedBird_base64encode(arrayBytes) {
    ...
    while (arrayBytes.length >= 3) {
        ...
        for (var i = 18; i >= 0; i -= 6)
            out += B64_CHARS[(bits >> i) & 0x3F];
