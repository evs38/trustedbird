...
/* Launch multi-LDAP certificate fetching after onComposerSendMessage function */
addEventListener('compose-send-message', fetchMissingCertificates, true);

function fetchMissingCertificates() {
  /* This function is taken from onComposerSendMessage() in msgCompSMIMEOverlay.js */
