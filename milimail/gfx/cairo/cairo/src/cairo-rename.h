...
#define cairo_os2_initialize _moz_cairo_os2_initialize
#define cairo_os2_surface_create _moz_cairo_os2_surface_create
#define cairo_os2_surface_get_blit_as_changes _moz_cairo_os2_surface_get_blit_as_changes
#define cairo_os2_surface_repaint_window _moz_cairo_os2_surface_repaint_window
#define cairo_os2_surface_set_blit_as_changes _moz_cairo_os2_surface_set_blit_as_changes
#define cairo_os2_surface_set_HWND _moz_cairo_os2_surface_set_HWND
#define cairo_os2_surface_window_resized _moz_cairo_os2_surface_window_resized
#define cairo_os2_uninitialize _moz_cairo_os2_uninitialize
